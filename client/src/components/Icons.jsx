...
export const CitizenIcon = ({ size = 32, className = '' }) => (
...
export const UniversityIcon = ({ size = 32, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IndustryIcon = ({ size = 32, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const AdminIcon = ({ size = 32, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M9.5 17a5 5 0 0 1 5 0" />
  </svg>
);

export const ChevronRight = ({ size = 18, className = '' }) => (
...
export const JharkhandMapSilhouette = ({ className = '' }) => (
  <svg viewBox="0 0 200 180" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path
      d="M45 40 Q70 20 110 30 T160 55 Q175 80 155 110 T130 145 Q90 160 60 140 T30 95 Q25 60 45 40 Z"
      fill="currentColor"
      opacity="0.12"
    />
    <path
      d="M60 55 Q95 40 125 50 T145 85 Q135 115 110 130 T65 120 Q45 90 60 55 Z"
      fill="currentColor"
      opacity="0.18"
    />
  </svg>
